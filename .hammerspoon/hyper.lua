...
hyper.launch = function(app) hs.application
    .launchOrFocusByBundleID(app.bundleID) end
...
-- simulate media keys
hyper:bind('', 'up', function() systemKey('SOUND_UP') end)
hyper:bind('', 'down', function() systemKey('SOUND_DOWN') end)
hyper:bind('', 'left', function() systemKey('PREVIOUS') end)
hyper:bind('', 'right', function() systemKey('NEXT') end)
hyper:bind('', '/', function() systemKey('PLAY') end)
                ...
                hyper:bind({}, key, nil, function()
                    if hs.application.get(app.bundleID) then
                        ...
                        hs.timer.waitWhile(
                            function()
                                return
                                    not hs.application.get(app.bundleID):isFrontmost()
                            end, function()
